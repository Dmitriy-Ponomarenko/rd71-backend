...
export const registerUserController = ctrlWrapper(async (
  req: Request,
  res: Response,
): Promise<void> => {
...
export const loginUserController = ctrlWrapper(async (
  req: Request,
  res: Response,
): Promise<void> => {
...
export const refreshSessionController = ctrlWrapper(async (
  req: Request,
  res: Response,
): Promise<void> => {
...
export const getSessionController = ctrlWrapper(async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
...
export const logoutUserController = ctrlWrapper(async (
  req: Request,
  res: Response,
): Promise<void> => {
